...
<head>
    ...
    <title>ZewedJobs Admin - <?php echo $page_title ?? 'Dashboard'; ?></title>
            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    <div class="text-center mb-4">
                        <h4 class="text-white mb-0">ZewedJobs</h4>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
                    <div class="container-fluid">
                        ...
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-dark"><?php echo $page_title ?? 'Dashboard'; ?></h5>
                        </div>
                        
                        <div class="d-flex align-items-center">
                            <span class="me-3 text-muted">Welcome, <?php echo $_SESSION['admin_name'] ?? 'Admin'; ?></span>
                            <div class="dropdown">
